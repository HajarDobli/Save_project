            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav  menu-navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#Emergency">Urgent</a>
                  </li>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 mb-4">
                <div class="card rounded-3">
                    <div class="story-img">
                        <img decoding="async" src="./images/stories/10yoboy.png" class="img-fluid">
                    </div>
                    <h5 style="text-align:center;  padding-top:20px;">Ahmed's Story</h5>
                    <div class="story-info pt-4 text-center">
                       
                        <p>Ahmed is a 10-year-old boy who has been suffering from a rare disease that caused him to lose his vision.With the help of our charity association, Ahmed was able to receive the medical treatment he needed and was able to regain his sight.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 mb-4">
                <div class="card rounded-3">
                    <div class="story-img">
                        <img decoding="async" src="./images/stories/7yogirl.jpg" class="img-fluid">
                    </div>
                    <h5 style="text-align:center;  padding-top:20px;">Sara's Story</h5>
                    <div class="story-info pt-4 text-center">
                        
                     
                        <p>Sara is a 7-year-old girl who was born with a congenital heart defect.Thanks to our charity association, Sara was able to receive the necessary surgeries and medical care to improve her health and quality of life.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 mb-4">
                <div class="card rounded-3">
                    <div class="story-img">
                        <img decoding="async" src="./images/stories/5yoboy 1.png" class="img-fluid">
                    </div>
                    <h5 style="text-align:center;  padding-top:20px;">Mohamed's Story</h5>
                    <div class="story-info pt-4 text-center">
                        
                       
                        <p>Mohamed is a 5-year-old boy who lost his parents in a tragic accident.Our charity association provided Mohamed with a safe and supportive home environment, and he has since thrived under our care.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <div class="form-group mb-4">
                        <input type="email" class="form-control text-black" placeholder="Enter Your Email Here">
                        <button type="submit" class="main-btn rounded-2 mt-3 border-white text-black"><a href="login-register-main/login.php">Subscribe</a></button>
...
?>
   ...
   <script>
    document.getElementById('dpopup').addEventListener('submit', function(event) {
    event.preventDefault(); // Empêche la soumission automatique du formulaire
    
    // Effectuer la redirection
    window.location.href = 'login-register-main/login.php';
});
</script>
